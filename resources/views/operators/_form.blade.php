...
<div class="row g-3">
    ...
    <div class="col-md-3"><label class="form-label">NIK</label><input type="text" name="nik" class="form-control" value="{{ old('nik', $operator->nik ?? '') }}" style="border-radius:10px;"></div>
    <div class="col-md-2"><label class="form-label">Phone</label><input type="text" name="phone" class="form-control" value="{{ old('phone', $operator->phone ?? '') }}" style="border-radius:10px;"></div>
