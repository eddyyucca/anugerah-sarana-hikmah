    ...
    <x-slot:header>
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 w-100">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('p2h.summary') }}" class="btn btn-outline-secondary btn-sm"><i class="bi bi-bar-chart me-1"></i>Summary</a>
                <a href="{{ route('p2h.create') }}" class="btn btn-danger btn-sm"><i class="bi bi-plus-lg me-1"></i> New P2H</a>
            </div>
        </div>
    </x-slot:header>
    <form method="GET" class="row g-2 mb-3">
        <div class="col-md-2">
            <input type="text" name="search" class="form-control form-control-sm" placeholder="P2H / Unit / Operator..." value="{{ request('search') }}">
        </div>
        <div class="col-md-2">
        ...
        <div class="col-auto">
            ...
            <a href="{{ route('p2h.index') }}" class="btn btn-light btn-sm">Reset</a>
        </div>
    </form>
        ...
        <table class="table table-modern mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('p2h.show', $c) }}" class="btn btn-sm btn-light"><i class="bi bi-eye"></i></a></td>
                </tr>
                @empty
