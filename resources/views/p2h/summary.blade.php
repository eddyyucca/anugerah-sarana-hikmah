...
<<<<<<< HEAD
        <x-card class="kpi-card card-accent-blue p-3">
=======
...
<<<<<<< HEAD
    ...
    <div class="col-6 col-xl-3">
        <x-card class="kpi-card card-accent-green p-3">
=======
        </div>
    </div>
    <div class="col-6 col-xl-3">
...
<<<<<<< HEAD
    ...
    <div class="col-6 col-xl-3">
        <x-card class="kpi-card card-accent-orange p-3">
=======
        </div>
    </div>
    <div class="col-6 col-xl-3">
...
<<<<<<< HEAD
    ...
    <div class="col-6 col-xl-3">
        <x-card class="kpi-card card-accent-red p-3">
=======
        </div>
    </div>
    <div class="col-6 col-xl-3">
...
<x-card class="mb-4">
    <div class="py-2">
        <form method="GET" class="row g-2 align-items-end">
            <div class="col-md-2"><label class="form-label" style="font-size:.8rem;">Date From</label><input type="date" name="date_from" class="form-control form-control-sm" value="{{ request('date_from') }}"></div>
            <div class="col-md-2"><label class="form-label" style="font-size:.8rem;">Date To</label><input type="date" name="date_to" class="form-control form-control-sm" value="{{ request('date_to') }}"></div>
            <div class="col-auto"><x-button type="submit" variant="outline-secondary" size="sm">Filter</x-button> <a href="{{ route('p2h.summary') }}" class="btn btn-light btn-sm">Reset</a></div>
        </form>
    </div>
</x-card>
=======
...
<div class="row g-3 mb-4">
    ...
    <div class="col-lg-4">
<<<<<<< HEAD
        <x-card style="min-height:100%;">
            <x-slot:header>
                <div class="section-title"><i class="bi bi-pie-chart me-2"></i>P2H Status Distribution</div>
            </x-slot:header>
...
<<<<<<< HEAD
        <x-card>
            <x-slot:header>
                <div class="section-title"><i class="bi bi-trophy me-2"></i>Unit Fitness Ranking</div>
            </x-slot:header>
...
<x-card class="mb-4">
    <x-slot:header>
        <div class="section-title"><i class="bi bi-truck me-2"></i>Unit P2H Summary & Kelayakan</div>
    </x-slot:header>
...
<x-card>
    <x-slot:header>
        <div class="section-title"><i class="bi bi-people me-2"></i>Operator P2H Performance</div>
    </x-slot:header>
    <div class="table-responsive">
        <table class="table table-modern mb-0">
            <thead><tr>
