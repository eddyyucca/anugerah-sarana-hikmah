...
<div class="print-header">
    ...
    <div>
        ...
        <div class="doc-number">{{ $goodsReceipt->gr_number }}</div>
    </div>
</div>
<table class="info-table">
    ...
    <tr>
        ...
        <td>{{ $goodsReceipt->purchaseOrder->supplier->supplier_name ?? '-' }}</td>
        <td class="label">Posted By</td>
        <td>{{ $goodsReceipt->postedByUser->name ?? '-' }}</td>
    </tr>
</table>
