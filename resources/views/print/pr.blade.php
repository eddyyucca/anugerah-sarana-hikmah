...
<div class="print-header">
    ...
    <div>
        ...
        <div class="doc-number">{{ $purchaseRequest->pr_number }}</div>
        <div class="doc-number">
            <span class="badge badge-{{ $purchaseRequest->status == 'approved' ? 'approved' : 'issued' }}">
...
<table class="info-table">
    ...
    <tr>
        ...
        <td>{{ $purchaseRequest->approver->name ?? '-' }}</td>
    </tr>
    @if($purchaseRequest->remarks)
    <tr>
        <td class="label">Remarks</td>
        <td colspan="3">{{ $purchaseRequest->remarks }}</td>
    </tr>
    @endif
</table>
...
<div class="sign-area">
    <div class="sign-box">
        ...
        <div class="sign-line">{{ $purchaseRequest->requester->name ?? '______' }}</div>
    </div>
    <div class="sign-box">
        <div>Approved By</div>
        <div class="sign-line">{{ $purchaseRequest->approver->name ?? '______' }}</div>
    </div>
</div>
@endsection
