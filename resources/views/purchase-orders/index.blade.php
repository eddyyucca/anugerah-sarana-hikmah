...
<x-card>
    <x-slot:header>
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 w-100">
            ...
            <a href="{{ route('purchase-orders.create') }}" class="btn btn-danger btn-sm"><i class="bi bi-plus-lg me-1"></i> Create PO</a>
        </div>
    </x-slot:header>
        ...
        <table class="table table-modern mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('purchase-orders.show', $po) }}" class="btn btn-sm btn-light"><i class="bi bi-eye"></i></a>
                        @if($po->status === 'draft')<a href="{{ route('purchase-orders.edit', $po) }}" class="btn btn-sm btn-light"><i class="bi bi-pencil"></i></a>@endif
                    </td>
                </tr>
