...
<x-card>
    <x-slot:header>
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 w-100">
            ...
            <a href="{{ route('purchase-requests.create') }}" class="btn btn-danger btn-sm"><i class="bi bi-plus-lg me-1"></i> Create PR</a>
        </div>
    </x-slot:header>
    <form method="GET" class="row g-2 mb-3">
        ...
        <div class="col-auto">
            ...
            <a href="{{ route('purchase-requests.index') }}" class="btn btn-light btn-sm">Reset</a>
        </div>
    </form>
        ...
        <table class="table table-modern mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('purchase-requests.show', $pr) }}" class="btn btn-sm btn-light"><i class="bi bi-eye"></i></a>
                        @if($pr->status === 'draft')
                        <a href="{{ route('purchase-requests.edit', $pr) }}" class="btn btn-sm btn-light"><i class="bi bi-pencil"></i></a>
                        @endif
                    </td>
                </tr>
