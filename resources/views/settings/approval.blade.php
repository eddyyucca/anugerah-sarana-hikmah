...
<<<<<<< HEAD
                ...
                <div class="col-md-1">
                    <label class="form-label" style="font-size:.8rem;">Order</label>
                    <input type="number" name="level_order" class="form-control form-control-sm" value="1" min="1" required>
                </div>
                <div class="col-md-2">
                    <label class="form-label" style="font-size:.8rem;">Min Budget</label>
                    <input type="number" name="min_budget" class="form-control form-control-sm" value="0" min="0">
                </div>
                <div class="col-md-2">
                    <label class="form-label" style="font-size:.8rem;">Max Budget</label>
                    <input type="number" name="max_budget" class="form-control form-control-sm" placeholder="Unlimited">
                </div>
                <div class="col-md-2">
                    <label class="form-label" style="font-size:.8rem;">Approver</label>
                    <select name="approver_user_id" class="form-select form-select-sm tom-select">
...
<<<<<<< HEAD
            <select name="document_type" class="form-select form-select-sm tom-select" style="width:auto;">
                ...
                @foreach(['pr'=>'PR','po'=>'PO','wo'=>'WO','gi'=>'GI'] as $k=>$v)
                    <option value="{{ $k }}" {{ request('document_type')==$k?'selected':'' }}>{{ $v }}</option>
                @endforeach
            </select>
