<x-form-row>
    ...
    <x-form-input name="bin_location" label="Bin Location" value="{{ old('bin_location', $sparepart->bin_location ?? '') }}" placeholder="cth: A-01, B-03" class="col-md-2" />
    <x-form-select name="category_id" label="Category" class="col-md-2">
