...
<<<<<<< HEAD
        <a href="{{ route('spareparts.create') }}" class="btn btn-danger btn-sm"><i class="bi bi-plus-lg me-1"></i> Add Sparepart</a>
    </div>
    <div class="erp-card-body">
        <form method="GET" class="row g-2 mb-3">
            <div class="col-md-3"><input type="text" name="search" class="form-control form-control-sm" placeholder="Search part number / name..." value="{{ request('search') }}"></div>
            <div class="col-md-2">
...
>>>>>>> a456df66c536f85e5f8af9e06880d7e6a6f56a1c
            ...
            <div class="col-md-2">
<<<<<<< HEAD
                <select name="stock_filter" class="form-select form-select-sm tom-select">
=======
...
<<<<<<< HEAD
                ...
                <a href="{{ route('spareparts.index') }}" class="btn btn-light btn-sm">Reset</a>
=======
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $sp->stock_on_hand }}
<<<<<<< HEAD
                            @if($sp->isLowStock()) <span class="badge badge-soft-danger">Low</span> @endif
                        </td>
                        <td>{{ $sp->minimum_stock }}</td>
                        <td>
                            <a href="{{ route('spareparts.show', $sp) }}" class="btn btn-sm btn-light"><i class="bi bi-eye"></i></a>
                            <a href="{{ route('spareparts.edit', $sp) }}" class="btn btn-sm btn-light"><i class="bi bi-pencil"></i></a>
                            <form action="{{ route('spareparts.destroy', $sp) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete?')">@csrf @method('DELETE')<button class="btn btn-sm btn-light text-danger"><i class="bi bi-trash"></i></button></form>
=======
