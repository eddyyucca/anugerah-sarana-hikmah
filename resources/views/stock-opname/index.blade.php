...
<<<<<<< HEAD
        <a href="{{ route('stock-opname.create') }}" class="btn btn-danger btn-sm"><i class="bi bi-plus-lg me-1"></i>New Opname</a>
    </div>
    <div class="erp-card-body">
        <form method="GET" class="row g-2 mb-3">
            <div class="col-md-3">
                <input type="text" name="search" class="form-control form-control-sm" placeholder="Opname number..." value="{{ request('search') }}">
            </div>
            <div class="col-md-2">
                <select name="status" class="form-select form-select-sm tom-select">
                    <option value="">All Status</option>
                    @foreach(['draft','completed'] as $s)
...
<<<<<<< HEAD
                        <td><a href="{{ route('stock-opname.show', $o) }}" class="btn btn-sm btn-light"><i class="bi bi-eye"></i></a></td>
=======
