...
<<<<<<< HEAD
        <a href="{{ route('technicians.create') }}" class="btn btn-danger btn-sm"><i class="bi bi-plus-lg me-1"></i> Add Technician</a>
    </div>
            ...
            <table class="table table-modern mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
<<<<<<< HEAD
                            <a href="{{ route('technicians.show', $tech) }}" class="btn btn-sm btn-light"><i class="bi bi-eye"></i></a>
                            <a href="{{ route('technicians.edit', $tech) }}" class="btn btn-sm btn-light"><i class="bi bi-pencil"></i></a>
                            <form action="{{ route('technicians.destroy', $tech) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete?')">@csrf @method('DELETE')<button class="btn btn-sm btn-light text-danger"><i class="bi bi-trash"></i></button></form>
=======
