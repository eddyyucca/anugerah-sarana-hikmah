...
<div class="erp-card">
    <div class="erp-card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <a href="{{ route('warehouse-transfer.create') }}" class="btn btn-danger btn-sm"><i class="bi bi-plus-lg me-1"></i>New Transfer</a>
    </div>
    <div class="erp-card-body">
        <form method="GET" class="row g-2 mb-3">
            <div class="col-md-3">
                <input type="text" name="search" class="form-control form-control-sm" placeholder="Transfer number..." value="{{ request('search') }}">
            </div>
            <div class="col-md-2">
            ...
            <table class="table table-modern mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('warehouse-transfer.show', $t) }}" class="btn btn-sm btn-light"><i class="bi bi-eye"></i></a></td>
                    </tr>
