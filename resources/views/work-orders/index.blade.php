...
<x-card>
    <x-slot:header>
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 w-100">
            ...
            <a href="{{ route('work-orders.create') }}" class="btn btn-danger btn-sm"><i class="bi bi-plus-lg me-1"></i> Create WO</a>
        </div>
    </x-slot:header>
    <form method="GET" class="row g-2 mb-3">
        <div class="col-md-2">
            <input type="text" name="search" class="form-control form-control-sm" placeholder="WO / Unit..." value="{{ request('search') }}">
        </div>
        <div class="col-md-2">
        ...
        <div class="col-auto">
            ...
            <a href="{{ route('work-orders.index') }}" class="btn btn-light btn-sm">Reset</a>
        </div>
    </form>
        ...
        <table class="table table-modern mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('work-orders.show', $wo) }}" class="btn btn-sm btn-light"><i class="bi bi-eye"></i></a>
                        @if(!in_array($wo->status, ['completed','cancelled']))
                        <a href="{{ route('work-orders.edit', $wo) }}" class="btn btn-sm btn-light"><i class="bi bi-pencil"></i></a>
                        @endif
                    </td>
                </tr>
                @empty
